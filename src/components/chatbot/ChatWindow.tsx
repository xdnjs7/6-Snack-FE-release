...
export default function ChatWindow({ messages, isLoading, onSendMessage, onResend, onClose }: ChatWindowProps) {
  ...
  return (
    <div
      className="fixed z-[55] flex flex-col overflow-hidden rounded-xl border border-primary-200)]
                 bg-primary-25)]/95 backdrop-blur-md shadow-[0_4px_18px_-4px_rgba(0,0,0,0.18),0_2px_6px_rgba(0,0,0,0.08)]
