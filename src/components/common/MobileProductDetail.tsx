    ...
    <div className="w-full flex flex-col justify-center items-center px-6 sm:px-0 sm:max-w-[1180px]">
      ...
      <div className="w-full flex flex-col justify-center items-start gap-7.5">
        ...
        <div className="pt-3.5 pb-2.5 sm:pt-0 sm:pb-5 flex justify-start items-center gap-1 sm:gap-1.5 sm:h-16 sm:w-full sm:border-b sm:border-primary-100">
          <p className="font-normal text-sm/[17px] sm:text-base/[20px] text-primary-200 tracking-tight">음료</p>
          <div>
        ...
        <div className="self-center relative w-full max-w-[328px] sm:max-w-[496px] aspect-square">
          <Image src={img_coke_zero} alt="코카콜라 제로" fill className="object-contain" />
        </div>
      </div>

      {/* (상품 정보) (장바구니담기부터 아래 부분) wrapper  */}
      <div className="flex flex-col justify-center items-center w-full gap-8 sm:gap-10 pt-7.5 sm:pt-8">
        {/* 상품정보 wrapper */}
        ...
        <div className="flex flex-col justify-center items-center w-full">
          ...
          <div className="self-stretch py-7.5 sm:py-10 border-b border-primary-200 inline-flex flex-col justify-center items-start gap-1.5 sm:gap-2">
            <div className="self-stretch inline-flex justify-between items-center">
              <div className="text-primary-950 text-base/[20px] sm:text-lg/[22px] font-bold tracking-tight">
                구매혜택
              </div>
              <PlusToggleIconSvg isOpen={isBenefitOpen} onClick={() => setIsBenefitOpen(!isBenefitOpen)} />
            </div>
            {isBenefitOpen && (
              <div className="text-primary-600 text-sm sm:text-base/[22px] font-normal sm:font-normal tracking-tight">
                5포인트 적립 예정
              </div>
            )}
          </div>
          ...
          <div className="self-stretch py-7.5 sm:py-10 border-b border-primary-200 inline-flex flex-col justify-center items-start gap-1.5 sm:gap-2">
            ...
            {isDeliveryMethodOpen && (
              <div className="text-primary-600 text-sm sm:text-base/[22px] font-normal tracking-tight">택배</div>
            )}
          </div>
          ...
          <div className="self-stretch py-7.5 sm:py-10 border-b border-primary-200 inline-flex flex-col justify-center items-start gap-1.5 sm:gap-2">
            <div className="self-stretch inline-flex justify-between items-center">
              <div className="text-primary-950 text-base/[20px] sm:text-lg/[22px] font-bold tracking-tight">배송비</div>
              <PlusToggleIconSvg isOpen={isDeliveryFeeOpen} onClick={() => setIsDeliveryFeeOpen(!isDeliveryFeeOpen)} />
            </div>
            {isDeliveryFeeOpen && (
              <div className="text-primary-600 text-sm sm:text-base/[20px] font-normal tracking-tight">
