...
import { TInviteMemberModalProps, Role } from "@/types/InviteMemberModal.types";

export default function InviteMemberModal({ onCancel, onSubmit }: TInviteMemberModalProps) {
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-7">
              <div className="self-stretch flex flex-col justify-start items-start gap-5">
                <input
                  ...
                  className="self-stretch h-14 px-1 py-2 border-b border-stone-500 inline-flex justify-between items-center overflow-hidden bg-transparent outline-none text-base font-normal font-['SUIT'] placeholder:text-zinc-500"
                />
                <input
                  type="email"
                  value={email}
        ...
        <div className="w-full px-6 left-0 top-[80px] absolute inline-flex flex-col justify-start items-start gap-7">
          <div className="self-stretch flex flex-col justify-start items-start gap-5">
            ...
            >
              <div className="flex-1 inline-flex flex-col justify-start items-start gap-[5px]">
                <div className="self-stretch justify-center text-neutral-400 text-xs font-normal font-['SUIT']">이름</div>
                <input
                  type="text"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  placeholder="이름을 입력해주세요"
                  className="self-stretch justify-center text-neutral-600 text-base font-normal font-['SUIT'] bg-transparent outline-none"
                />
              </div>
            </div>
            <div 
            ...
            >
              <div className="flex-1 inline-flex flex-col justify-start items-start gap-[5px]">
                <div className="self-stretch justify-center text-neutral-400 text-xs font-normal font-['SUIT']">이메일</div>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
          ...
          <div className="self-stretch flex flex-col justify-center items-start gap-3">
            ...
            <div className="self-stretch flex flex-col justify-start items-start">
              ...
              {isDropdownOpen && (
                <div data-height-type="auto" className="w-full bg-white border-l border-r border-b border-neutral-200 flex flex-col justify-center items-start overflow-hidden">
                  {Object.entries(roleLabels).map(([role, label]) => (
                    <div
                      key={role}
        ...
        <div className="w-full p-6 left-0 bottom-0 absolute bg-white inline-flex flex-col justify-start items-start gap-2">
          <div className="self-stretch inline-flex justify-start items-center gap-4">
            ...
            <button
              ...
              onClick={handleSubmit}
            >
              <div className="text-center justify-center text-white text-base font-bold font-['SUIT']">초대하기</div>
            </button>
          </div>
        </div>
      </div>
