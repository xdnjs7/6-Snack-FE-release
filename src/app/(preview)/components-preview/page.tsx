...
import ProductCancel from "@/components/ui/ProductCancel";
import ProductModify from "@/components/ui/ProductModify";
...
export default function ComponentsPreviewPage() {
  ...
  return (
    <div className="p-6 space-y-6 bg-white min-h-screen">
      ...
      <div className="space-y-4">
        <h2 className="text-lg font-semibold bg-blue-200">상품수정/삭제 컴포넌트(UI)</h2>
        <ProductCancel />
        <ProductModify />
        <ProductRegister />
      </div>
