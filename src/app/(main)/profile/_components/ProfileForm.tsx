...
export default function ProfileForm() {
  ...
  return (
    <main aria-label="프로필 변경 페이지" className="w-full">
      <Toast text={toastMessage} variant={toastVariant} isVisible={toastVisible} />

      <form
        onSubmit={handleSubmit(onSubmit)}
        className="w-full sm:w-[600px] sm:px-14 sm:rounded-sm sm:shadow-[0px_0px_40px_0px_rgba(0,0,0,0.10)] ] py-10 inline-flex flex-col justify-center items-start gap-5"
