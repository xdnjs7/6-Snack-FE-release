...
export default function SubCategoryTabs() {
  ...
  return (
    <div className="w-full border-b border-primary-100 inline-flex justify-start items-center gap-2 sm:hidden">
      {childrenCategories.map((child) => (
        <button
          key={child.id}
          className="h-12 px-2 py-3.5 flex justify-center items-center gap-2.5"
